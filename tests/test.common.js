...
//  TEST: caya.compose
//
//  Checks if caya.compose() is working properly. Should be tested with older
//  browsers to ensure ES6's Object.Assign is being emulated properly.
//
///////////////////////////////////////////////////////////////////////////////

QUnit.test("caya.compose", function(assert) {
	...
	for (var i = 0; i < N; i++) {
		...
		composed = caya.compose(composed, to_compose);
		// add manually
